  ...
  return (
    <section className="bg-bg">
      <div className="container-max py-16">
        <p className="font-pixel text-[20px] text-red">COMPETITION AWARDS</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            {AWARD_TABS.map((t) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full text-center px-18 py-4 rounded-full font-pixel text-xl transition-all duration-200 border",
                    active
          ...
          <div className="lg:col-span-2">
            <div className="relative flex flex-col items-center justify-center py-12">
              <h3 className="font-pixel text-3xl mb-8">{prize.title}</h3>
              ...
              <div className="flex items-center">
                ...
                {currentPrizes.length > 1 && (
                  ...
                  >
                    <ChevronLeft size={80} strokeWidth={3} />
                  </button>
                )}
                  ...
                  {prize.images.map((src, i) => (
                    <div key={i} className="flex flex-col items-center gap-3">
                      <Image
                        ...
                        width={240}
                        height={240}
                        className="w-24 sm:w-60 h-auto pixelated drop-shadow-md select-none"
                      />
                    </div>
                  ))}
                </div>
              ...
              <p className="mt-8 font-pixel text-lg">
                {prize.caption}
              </p>
            </div>
          </div>
