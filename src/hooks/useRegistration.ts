...
export function useRegistration() {
  ...
  function validateField(fieldName: string, value: any, currentMembers: MemberDraft[], currentTeamName: string): string | undefined {
    if (fieldName === "team_name") {
      ...
      if (letterCount < 3) return "Team name must contain at least 3 English letters.";
      return undefined;
    }
    ...
    if (memberMatch) {
      ...
      if (key === "birth_date") {
        ...
        // Max Age 25: Born on or after Feb 1, 2000
        ...
        if (bDate < minDate) return "Participant is too old. Must be born on or after Feb 1, 2000 (Max 25 years).";
